...
public partial class @XRIDefaultInputActions: IInputActionCollection2, IDisposable
{
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""ToDoUI"",
                    ""type"": ""Button"",
                    ""id"": ""f2b2073f-9932-420d-a07c-d0075b9f541d"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""11c2847b-10b2-4170-a075-5ccb82ba9cb5"",
    ...
    ""controlSchemes"": [
        ...
        m_XRILeftHandInteraction_ToDoUI = m_XRILeftHandInteraction.FindAction("ToDoUI", throwIfNotFound: true);
    ...
    private readonly InputAction m_XRILeftHandInteraction_ToDoUI;
    public struct XRILeftHandInteractionActions
    {
        ...
        public InputAction @ToDoUI => m_Wrapper.m_XRILeftHandInteraction_ToDoUI;
        ...
        public void AddCallbacks(IXRILeftHandInteractionActions instance)
        {
            ...
            @ToDoUI.started += instance.OnToDoUI;
            @ToDoUI.performed += instance.OnToDoUI;
            @ToDoUI.canceled += instance.OnToDoUI;
        }
    ...
    public interface IXRILeftHandInteractionActions
    {
        ...
        void OnToDoUI(InputAction.CallbackContext context);
    }
